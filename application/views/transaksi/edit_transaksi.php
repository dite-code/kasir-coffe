            ...
            <div class="box">
                <div class="box-body">
                    <table class="table no-border">
                        ...
                        <tr>
                            <td colspan="2">							
								<button class="btn btn-flat btn-warning"><i class="fa fa-save"></i> Simpan Order</button>
							</td>
							<td align="right">
								<button class="btn btn-flat btn-success" onclick="bayar();" type="button"><i class="fa fa-money"></i> Pembayaran </button>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 'true') {
						...
						location.replace("<?= base_url(); ?>index.php/home/kasir.html");
                    } else {
	...
	function bayar(){
		//alert('oke');
		var url_form = '<?= base_url(); ?>index.php/transaksi/Trans_order/bayarOrder.html';
        $.ajax({
			type: 'POST',
			url: url_form,
